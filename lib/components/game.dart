...
import 'package:forge2d_game/components/enemy.dart';
...
// Base class Flame Game supaya bisa pake physics
class MyPhysicsGame extends Forge2DGame {
  MyPhysicsGame()
      : super(
          // Element dari Forge2D, salah satunya bisa set gravity
          gravity: Vector2(0, 10),
          // Camera: Component yang ngeobserve si world itu sendiri
